 ...
 * (lista_borrar o lista_destruir) se invoca al destructor pasandole
 * el elemento.
 */
typedef void (*lista_liberar_elemento)(void* elemento);
...
/*
 * Crea la lista reservando la memoria necesaria y le asigna el destructor recibido.
 * Si no se quiere usar destructor, se envía NULL.
